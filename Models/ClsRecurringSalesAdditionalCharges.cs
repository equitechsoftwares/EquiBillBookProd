...
namespace EquiBillBook.Models
{
    ...
    [Table("public.tblRecurringSalesAdditionalCharges")]
    public class ClsRecurringSalesAdditionalCharges
    {
        [Key]
        public long RecurringSalesAdditionalChargesId { get; set; }
    ...
    public class ClsRecurringSalesAdditionalChargesVm
    {
        public long RecurringSalesAdditionalChargesId { get; set; }
        public long RecurringSalesId { get; set; }
        public long TaxId { get; set; }
