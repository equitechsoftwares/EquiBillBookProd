...
{
    [Table("public.tblSalesOrderAdditionalCharges")]
    public class ClsSalesOrderAdditionalCharges
    {
        [Key]
        public long SalesOrderAdditionalChargesId { get; set; }
    ...
    public class ClsSalesOrderAdditionalChargesVm
    {
        public long SalesOrderAdditionalChargesId { get; set; }
        public long SalesOrderId { get; set; }
        public long TaxId { get; set; }
