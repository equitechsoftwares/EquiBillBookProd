...
{
    [Table("public.tblPurchaseQuotationAdditionalCharges")]
    public class ClsPurchaseQuotationAdditionalCharges
    {
        [Key]
        public long PurchaseQuotationAdditionalChargesId { get; set; }
    ...
    public class ClsPurchaseQuotationAdditionalChargesVm
    {
        public long PurchaseQuotationAdditionalChargesId { get; set; }
        public long PurchaseQuotationId { get; set; }
        public long TaxId { get; set; }
