...
{
    [Table("public.tblSalesProformaAdditionalCharges")]
    public class ClsSalesProformaAdditionalCharges
    {
        [Key]
        public long SalesProformaAdditionalChargesId { get; set; }
    ...
    public class ClsSalesProformaAdditionalChargesVm
    {
        public long SalesProformaAdditionalChargesId { get; set; }
        public long SalesProformaId { get; set; }
        public long TaxId { get; set; }
