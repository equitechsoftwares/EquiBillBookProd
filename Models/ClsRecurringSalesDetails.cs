...
{
    [Table("public.tblRecurringSalesDetails")]
    public class ClsRecurringSalesDetails
    {
        [Key]
        public long RecurringSalesDetailsId { get; set; }
    ...
    public class ClsRecurringSalesDetailsVm
    {
        public long RecurringSalesDetailsId { get; set; }
        public long RecurringSalesId { get; set; }
        public long ItemId { get; set; }
