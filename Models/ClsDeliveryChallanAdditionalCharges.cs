...
{
    [Table("public.tblDeliveryChallanAdditionalCharges")]
    public class ClsDeliveryChallanAdditionalCharges
    {
        [Key]
        public long DeliveryChallanAdditionalChargesId { get; set; }
    ...
    public class ClsDeliveryChallanAdditionalChargesVm
    {
        public long DeliveryChallanAdditionalChargesId { get; set; }
        public long DeliveryChallanId { get; set; }
        public long TaxId { get; set; }
