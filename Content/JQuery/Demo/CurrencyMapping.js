...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/settings1/currencyMappingFetch',
        datatype: "json",
        data: det,
        type: "post",
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                if (i == 1) {
                    window.location.href = "/settings1/currencymappinglist";
                }
                else {
...
function update() {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/settings1/currencyMappingUpdate',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function ActiveInactive(UserCurrencyMapId, IsActive) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/settings1/currencyMappingActiveInactive',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function Delete(UserCurrencyMapId, currencyName) {
    ...
    if (r == true) {
        ...
        $("#divLoading").show();
        $.ajax({
            url: '/settings1/currencyMappingdelete',
            datatype: "json",
            data: det,
            type: "post",
            success: function (data) {
