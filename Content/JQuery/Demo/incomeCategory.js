...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/Income/IncomeCategoryFetch',
        datatype: "json",
        data: det,
        type: "post",
        ...
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                if (i == 1) {
                    ...
                    window.location.href = "/Income/categoryadd";
                }
            }
        },
        error: function (xhr) {
...
function update(i) {
    ...
    var det = {
        IncomeCategoryId: window.location.href.split('=')[1],
        IncomeCategoryCode: $('#txtIncomeCategoryCode').val(),
        IncomeCategory: $('#txtIncomeCategory').val(),
    };
    $("#divLoading").show();
    $.ajax({
        url: '/Income/IncomeCategoryUpdate',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function ActiveInactive(IncomeCategoryId, IsActive) {
    var det = {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/Income/IncomeCategoryActiveInactive',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function Delete(IncomeCategoryId, IncomeCategoryName) {
    ...
    if (r == true) {
        ...
        $("#divLoading").show();
        $.ajax({
            url: '/Income/IncomeCategorydelete',
            datatype: "json",
            data: det,
            type: "post",
            success: function (data) {
...
function exportToPdf() {
    ...
    html2canvas($('#tblData')[0], {
        onrendered: function (canvas) {
            ...
            pdfMake.createPdf(docDefinition).download("Income Category.pdf");
