...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/reports/CustomerPaymentFetch',
        datatype: "json",
        data: det,
        type: "post",
...
function exportToExcel() {
    ...
    TableToExcel.convert(document.getElementById("tblData"), {
        name: "Sales Payment Report.xlsx",
        sheet: {
            name: "Sheet1"
        }
    });
...
function exportToPdf() {
    ...
    html2canvas($('#tblData')[0], {
        onrendered: function (canvas) {
            ...
            pdfMake.createPdf(docDefinition).download("Sales Payment Report.pdf");
