    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                if (i == 1) {
                    window.location.href = "/master/State";
                }
                else {
                    window.location.href = "/master/stateadd";
                }
...
function update(i) {
    ...
    var det = {
        CountryId: $('#ddlCountry').val(),
        StateId: window.location.href.split('=')[1],
        StateCode: $('#txtStateCode').val(),
        State: $('#txtState').val(),
    };
    $("#divLoading").show();
    $.ajax({
        url: '/master/StateUpdate',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function ActiveInactive(StateId, IsActive) {
    var det = {
        StateId: StateId,
        IsActive: IsActive
    };
    $("#divLoading").show();
    $.ajax({
        url: '/master/StateActiveInactive',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function Delete(StateId, StateName) {
...
function exportToPdf() {
    ...
    html2canvas($('#tblData')[0], {
        onrendered: function (canvas) {
            ...
            pdfMake.createPdf(docDefinition).download("State.pdf");
