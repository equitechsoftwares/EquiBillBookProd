...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/accounts/BalanceSheetFetch',
        datatype: "json",
        data: det,
        type: "post",
...
function exportToExcel() {
    ...
    TableToExcel.convert(document.getElementById("tblData"), {
        name: "Balance Sheet Report.xlsx",
        sheet: {
            name: "Sheet1"
        }
    });
...
function exportToPdf() {
    ...
    html2canvas($('#tblData')[0], {
        onrendered: function (canvas) {
            ...
            pdfMake.createPdf(docDefinition).download("Balance Sheet Report.pdf");
