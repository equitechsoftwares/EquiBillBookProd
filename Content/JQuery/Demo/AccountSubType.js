...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/accounts/AccountSubTypeFetch',
        datatype: "json",
        data: det,
        type: "post",
...
function insert(i) {
    ...
    var det = {
        AccountTypeId: $('#ddlAccountType').val(),
        ParentId: $('#ddlAccountSubType').val(),
        //AccountSubTypeCode: $('#txtAccountSubTypeCode').val(),
        AccountSubType: $('#txtAccountSubType').val(),
        DisplayAs: $('#ddlAccountSubType').val() == 0 ? $('#txtAccountSubType').val() : $("#ddlAccountSubType option:selected").text() + ' -> ' + $('#txtAccountSubType').val(),
        IsActive: true,
        IsDeleted: false,
    };
    $("#divLoading").show();
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                if (i == 1) {
                    window.location.href = "/accounts/AccountSubType";
                }
                else {
                    window.location.href = "/accounts/AccountSubTypeadd";
                }
            }
...
function update(i) {
    ...
    var det = {
        AccountTypeId: $('#ddlAccountType').val(),
        ParentId: $('#ddlAccountSubType').val(),
        AccountSubTypeId: window.location.href.split('=')[1],
        //AccountSubTypeCode: $('#txtAccountSubTypeCode').val(),
        AccountSubType: $('#txtAccountSubType').val(),
        DisplayAs: $('#ddlAccountSubType').val() == 0 ? $('#txtAccountSubType').val() : $("#ddlAccountSubType option:selected").text() + ' -> ' + $('#txtAccountSubType').val(),
    };
    $("#divLoading").show();
    $.ajax({
        url: '/accounts/AccountSubTypeUpdate',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function ActiveInactive(AccountSubTypeId, IsActive) {
    var det = {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/accounts/AccountSubTypeActiveInactive',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function Delete(AccountSubTypeId, AccountSubType) {
    ...
    if (r == true) {
        ...
        $("#divLoading").show();
        $.ajax({
            url: '/accounts/AccountSubTypedelete',
            datatype: "json",
            data: det,
            type: "post",
            success: function (data) {
...
function exportToPdf() {
    ...
    html2canvas($('#tblData')[0], {
        onrendered: function (canvas) {
            ...
            pdfMake.createPdf(docDefinition).download("Account Sub Type.pdf");
...
function fetchActiveAccountSubTypes() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#ddlAccountSubType").append($("<option></option>").val(0).html("None"));
