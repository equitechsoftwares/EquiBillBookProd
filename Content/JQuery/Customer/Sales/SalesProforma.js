$(function () {
    ...
    $('#_SalesProformaDate').datetimepicker({ widgetPositioning: { horizontal: 'auto', vertical: 'bottom' }, format: DateFormat.toUpperCase() + ' ' + TimeFormat, defaultDate: new Date() });
    $('#_PaymentDate').datetimepicker({ widgetPositioning: { horizontal: 'auto', vertical: 'bottom' }, format: DateFormat.toUpperCase() + ' ' + TimeFormat });
    $('#_SalesProformaDate').addClass('notranslate');
...
function fetchList(PageIndex) {
    ...
    var det = {
        ...
        SalesProformaType: $('#ddlSalesProformaType').val(),
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/SalesProforma/SalesProformaFetch',
        datatype: "json",
        data: det,
        type: "post",
...
function deleteFullCombo(SalesProformaId) {
    if (SalesProformaId != undefined) {
        //var r = confirm("This will delete permanently. This process cannot be undone. Are you sure you want to continue?");
        //if (r == true) {
        $('#divCombo tr').each(function () {
            var _id = this.id.split('divCombo')[1];
            ...
            //var det = {
            //    SalesProformaId: SalesProformaId
            //}
            //$("#divLoading").show();
            //$.ajax({
            //    url: '/Sales/SalesDetailsDelete',
...
function insert(i) {
    ...
    var det = {
        ...
        SalesProformaDate: moment($("#txtSalesProformaDate").val(), DateFormat.toUpperCase() + ' ' + TimeFormat + ' a').format('YYYY-MM-DDTHH:mm'),//$("#txtSalesProformaDate").val(),
        Status: $("#ddlStatus").val(),
        ...
        IsActive: true,
        IsDeleted: false,
        SalesProformaDetails: ItemDetails,
        SalesProformaType: $("#ddlSalesProformaType").val(),
        SellingPriceGroupId: $('#ddlSellingPriceGroup').val(),
        ...
        SalesProformaAdditionalCharges: additionalCharges,
        SpecialDiscount: $('#txtSpecialDiscount').val()
    };
    $("#divLoading").show();
    $.ajax({
        url: '/SalesProforma/SalesProformaInsert',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                if (data.Data.SaleSetting.AutoPrintInvoiceProforma == true) {
                        sessionStorage.setItem('InvoiceUrl', '/SalesProforma/invoice?InvoiceId=' + data.Data.SalesProforma.InvoiceId);
                    }
                //}
                //else if (Status == 'Sent') {
                ...
                if (i == 1) {
                    window.location.href = "/SalesProforma/index";
                }
                else {
                    window.location.href = "/SalesProforma/add";
                }
...
function update(i) {
    ...
    $('#divCombo tr').each(function () {
        ...
        if (_id != undefined) {
            ...
            ItemDetails.push({
                SalesProformaDetailsId: $('#txtSalesProformaDetailsId' + _id).val(),
                DivId: _id,
                Quantity: $('#txtQuantity' + _id).val(),
                AmountExcTax: $('#txtAmountExcTax' + _id).val(),
                AmountIncTax: $('#txtAmountIncTax' + _id).val(),
    ...
    $('#divAdditionalCharges .additional-charges-row').each(function (index) {
        ...
        var additionalChargeId = $('#txtAdditionalChargeId' + count).val();
        var taxExemptionId = $('#exemptionReasonId' + count).val();
        var salesProformaAdditionalChargesId = $('#txtSalesProformaAdditionalChargesId' + count).val();
        additionalCharges.push({
            AdditionalChargeId: additionalChargeId,
            TaxId: taxId,
            AmountExcTax: additionalChargesAmountExcTax,
            AmountIncTax: additionalChargesAmountIncTax,
            TaxExemptionId: taxExemptionId,
            SalesProformaAdditionalChargesId: salesProformaAdditionalChargesId,
            IsActive: true,
            IsDeleted: false
        })
    });
    ...
    var det = {
        SalesProformaId: window.location.href.split('=')[1],
        IsReverseCharge: $('#chkIsReverseCharge').is(':checked') == true ? 1 : 2,
        GrandTotalReverseCharge: $("#divGrandTotal_reversecharge").text().replace(/[^-0-9\.]+/g, ""),
        RoundOffReverseCharge: $("#divRoundOff_reversecharge").text().replace(/[^-0-9\.]+/g, ""),
        NetAmountReverseCharge: $("#divNetAmount_reversecharge").text().replace(/[^-0-9\.]+/g, ""),
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/SalesProforma/SalesProformaUpdate',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function Delete(SalesProformaId) {
    var r = confirm("This will delete permanently. This process cannot be undone. Are you sure you want to continue?");
    if (r == true) {
        var det = {
            SalesProformaId: SalesProformaId,
        ...
        $("#divLoading").show();
        $.ajax({
            url: '/SalesProforma/SalesProformadelete',
            datatype: "json",
            data: det,
            type: "post",
            success: function (data) {
...
function View(SalesProformaId) {
    var det = {
        SalesProformaId: SalesProformaId
    };
    $("#divLoading").show();
    $.ajax({
        url: '/SalesProforma/SalesProformaView',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function UpdateSalesStatus() {
    ...
    var det = {
        SalesProformaId: _SalesProformaId,
        Status: $("#ddlSalesStatus_M").val(),
    };
    $("#divLoading").show();
    $.ajax({
        url: '/SalesProforma/UpdateSalesProformaStatus',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                if (data.Data.SaleSetting.AutoPrintInvoiceProforma == true) {
                    PrintInvoice('/SalesProforma/invoice?InvoiceId=' + data.Data.SalesProforma.InvoiceId);
                }
            }
        },
        error: function (xhr) {
...
function AcceptDeclineSalesStatus(_id, Status) {
    var r = confirm("This will mark the Sales Proforma as " + Status + ". This process cannot be undone. Are you sure you want to continue?");
    if (r == true) {
        $('.errorText').hide();
        $('[style*="border: 2px"]').css('border', '');
