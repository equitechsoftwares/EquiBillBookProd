...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/supportsettings/SupportTicketFetch',
        datatype: "json",
        data: det,
        type: "post",
...
function insert() {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/supportsettings/SupportTicketInsert',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                window.location.href = "/supportsettings/SupportTicket";
            }
        },
        error: function (xhr) {
            $("#divLoading").hide();
...
function SupportTicketDetailsInsert() {
    ...
    var det = {
        Message: $('#txtMessage').val(),
        SupportTicketId: window.location.href.split('=')[1]
    };
    $("#divLoading").show();
    $.ajax({
        url: '/supportsettings/SupportTicketDetailsInsert',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
