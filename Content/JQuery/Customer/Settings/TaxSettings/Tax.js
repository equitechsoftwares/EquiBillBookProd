...
function insert(i) {
    ...
    var det = {
        ...
        IsActive: true,
        IsDeleted: false,
        ForTaxGroupOnly: $('#chkForTaxGroupOnly').is(':checked'),
...
function ActiveInactive(TaxId, IsActive) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/taxsettings/TaxActiveInactive',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function toggleForTaxGroupOnly() {
    if ($('#chkForTaxGroupOnly').is(':checked') == true) {
        $('.divAccounts').hide();
    }
    else {
        $('.divAccounts').show();
