...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/itemsettings/SecondaryUnitFetch',
        datatype: "json",
        data: det,
        type: "post",
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                //window.location.href = "/itemsettings/SecondaryUnit";
                if (i == 1) {
                    window.location.href = "/itemsettings/SecondaryUnit";
                }
                else {
                    window.location.href = "/itemsettings/SecondaryUnitadd";
                }
            }
        },
        error: function (xhr) {
...
function update(i) {
    ...
    var det = {
        SecondaryUnitId: window.location.href.split('=')[1],
        SecondaryUnitCode: $('#txtSecondaryUnitCode').val(),
        UnitId: $('#ddlUnit').val(),
        SecondaryUnitName: $('#txtSecondaryUnitName').val(),
        SecondaryUnitShortName: $('#txtSecondaryUnitShortName').val(),
        SecondaryUnitAllowDecimal: $('#ddlAllowDecimal').val(),
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/itemsettings/SecondaryUnitUpdate',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function ActiveInactive(SecondaryUnitId, IsActive) {
    var det = {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/itemsettings/SecondaryUnitActiveInactive',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function Delete(SecondaryUnitId, SecondaryUnitName) {
    var r = confirm("This will delete \"" + SecondaryUnitName + "\" permanently. This process cannot be undone. Are you sure you want to continue?");
    if (r == true) {
        var det = {
            SecondaryUnitId: SecondaryUnitId,
        };
        $("#divLoading").show();
        $.ajax({
            url: '/itemsettings/SecondaryUnitdelete',
            datatype: "json",
            data: det,
            type: "post",
            success: function (data) {
