...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/itemsettings/QuaternaryUnitFetch',
        datatype: "json",
        data: det,
        type: "post",
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                //window.location.href = "/itemsettings/QuaternaryUnit";
                if (i == 1) {
                    window.location.href = "/itemsettings/QuaternaryUnit";
                }
                else {
                    window.location.href = "/itemsettings/QuaternaryUnitadd";
                }
            }
        },
        error: function (xhr) {
...
function update(i) {
    ...
    var det = {
        QuaternaryUnitId: window.location.href.split('=')[1],
        QuaternaryUnitCode: $('#txtQuaternaryUnitCode').val(),
        UnitId: $('#ddlUnit').val(),
        SecondaryUnitId: $('#ddlSecondaryUnit').val(),
        TertiaryUnitId: $('#ddlTertiaryUnit').val(),
        QuaternaryUnitName: $('#txtQuaternaryUnitName').val(),
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/itemsettings/QuaternaryUnitUpdate',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function ActiveInactive(QuaternaryUnitId, IsActive) {
    var det = {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/itemsettings/QuaternaryUnitActiveInactive',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function Delete(QuaternaryUnitId, QuaternaryUnitName) {
    var r = confirm("This will delete \"" + QuaternaryUnitName + "\" permanently. This process cannot be undone. Are you sure you want to continue?");
    if (r == true) {
        var det = {
            QuaternaryUnitId: QuaternaryUnitId,
        };
        $("#divLoading").show();
        $.ajax({
            url: '/itemsettings/QuaternaryUnitdelete',
            datatype: "json",
            data: det,
            type: "post",
            success: function (data) {
