...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/itemsettings/CategoryFetch',
        datatype: "json",
        data: det,
        type: "post",
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                if (i == 1) {
                    window.location.href = "/itemsettings/Category";
                }
                else {
                    window.location.href = "/itemsettings/categoryadd";
                }
            }
...
function update(i) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/itemsettings/CategoryUpdate',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function ActiveInactive(CategoryId, IsActive) {
    var det = {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/itemsettings/CategoryActiveInactive',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function Delete(CategoryId, CategoryName) {
    ...
    if (r == true) {
        ...
        $("#divLoading").show();
        $.ajax({
            url: '/itemsettings/Categorydelete',
            datatype: "json",
            data: det,
            type: "post",
            success: function (data) {
