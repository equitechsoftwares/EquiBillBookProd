...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/itemsettings/SubSubCategoryFetch',
        datatype: "json",
        data: det,
        type: "post",
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                if (i == 1) {
                    window.location.href = "/itemsettings/SubSubCategory";
                }
                else {
                    window.location.href = "/itemsettings/SubSubCategoryadd";
                }
            }
        },
        error: function (xhr) {
...
function update(i) {
    ...
    var det = {
        CategoryId: $('#ddlCategory').val(),
        SubCategoryId: $('#ddlSubCategory').val(),
        SubSubCategoryId: window.location.href.split('=')[1],
        SubSubCategoryCode: $('#txtSubSubCategoryCode').val(),
        SubSubCategory: $('#txtSubSubCategory').val(),
    };
    $("#divLoading").show();
    $.ajax({
        url: '/itemsettings/SubSubCategoryUpdate',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function ActiveInactive(SubSubCategoryId, IsActive) {
    var det = {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/itemsettings/SubSubCategoryActiveInactive',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function Delete(SubSubCategoryId, SubSubCategoryName) {
    var r = confirm("This will delete \"" + SubSubCategoryName + "\" permanently. This process cannot be undone. Are you sure you want to continue?");
    if (r == true) {
        var det = {
            SubSubCategoryId: SubSubCategoryId,
        };
        $("#divLoading").show();
        $.ajax({
            url: '/itemsettings/SubSubCategorydelete',
            datatype: "json",
            data: det,
            type: "post",
            success: function (data) {
