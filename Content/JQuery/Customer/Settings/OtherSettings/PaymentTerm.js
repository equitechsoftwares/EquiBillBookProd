...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/othersettings/paymentTermFetch',
        datatype: "json",
        data: det,
        type: "post",
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                if (i == 1) {
                    window.location.href = "/othersettings/paymentTermlist";
                }
                else {
                    window.location.href = "/othersettings/paymenttermadd";
                }
            }
        },
        error: function (xhr) {
...
function update(i) {
    ...
    var det = {
        paymentTermId: window.location.href.split('=')[1],
        PaymentTerm: $('#txtPaymentTerm').val(),
        Days: $('#txtDays').val(),
        /*IsPosShown: $('#chkIsPosShown').is(':checked')*/
    };
    $("#divLoading").show();
    $.ajax({
        url: '/othersettings/paymentTermUpdate',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function ActiveInactive(paymentTermId, IsActive) {
    var det = {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/othersettings/paymentTermActiveInactive',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function Delete(paymentTermId, paymentTermName) {
    ...
    if (r == true) {
        ...
        $("#divLoading").show();
        $.ajax({
            url: '/othersettings/paymentTermdelete',
            datatype: "json",
            data: det,
            type: "post",
            success: function (data) {
