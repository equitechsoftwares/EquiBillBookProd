...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/salessettings/customerGroupFetch',
        datatype: "json",
        data: det,
        type: "post",
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                if (i == 1) {
                    window.location.href = "/salessettings/customerGroup";
                }
                else {
                    window.location.href = "/salessettings/customergroupadd";
                }
            }
        },
        error: function (xhr) {
...
function update(i) {
    ...
    var det = {
        UserGroupId: window.location.href.split('=')[1],
        UserGroup: $('#txtUserGroup').val(),
        PriceCalculationType: $('#ddlPriceCalculationType').val(),
        CalculationPercentage: $('#txtCalculationPercentage').val(),
        SellingPriceGroupId: $('#ddlSellingPriceGroup').val(),
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/salessettings/customerGroupUpdate',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function ActiveInactive(UserGroupId, IsActive) {
    var det = {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/salessettings/customerGroupActiveInactive',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function Delete(UserGroupId, UserGroupName) {
    var r = confirm("This will delete \"" + UserGroupName +"\" permanently. This process cannot be undone. Are you sure you want to continue?");
    if (r == true) {
        var det = {
            UserGroupId: UserGroupId,
        };
        $("#divLoading").show();
        $.ajax({
            url: '/salessettings/customerGroupdelete',
            datatype: "json",
            data: det,
            type: "post",
            success: function (data) {
...
function insertSellingPriceGroup() {
    $('.errorText').hide();
    $('[style*="border: 2px"]').css('border', '');
    

    var det = {
        SellingPriceGroup: $('#txtSellingPriceGroup').val(),
        Description: $('#txtDescription').val(),
        IsActive: true,
        IsDeleted: false,
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/itemsettings/SellingPriceGroupInsert',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                $('#ddlSellingPriceGroup').append($('<option>', { value: data.Data.SellingPriceGroup.SellingPriceGroupId, text: data.Data.SellingPriceGroup.SellingPriceGroup }));
                $('#ddlSellingPriceGroup').val(data.Data.SellingPriceGroup.SellingPriceGroupId);
                $('#sellingPriceGroupModal').modal('toggle');

                $('#txtSellingPriceGroup').val('');
                $('#txtDescription').val('');
            }
        },
        error: function (xhr) {
