...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/notificationsettings/EmailSettingsFetch',
        datatype: "json",
        data: det,
        type: "post",
...
function insert(i) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/notificationsettings/EmailSettingInsert',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                if (i == 1) {
                    window.location.href = "/notificationsettings/emailsettings";
                }
                else {
                    window.location.href = "/notificationsettings/emailsettingsadd";
                }
            }
...
function update(i) {
    ...
    var det = {
        EmailSettingsId: window.location.href.split('=')[1],
        SmtpServer: $('#txtSmtpServer').val(),
        SmtpPort: $('#txtSmtpPort').val(),
        SmtpUser: $('#txtSmtpUser').val(),
        SmtpPass: $('#txtSmtpPass').val(),
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/notificationsettings/EmailSettingUpdate',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function ActiveInactive(EmailSettingsId, IsActive) {
    var det = {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/notificationsettings/EmailSettingActiveInactive',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function Delete(EmailSettingsId, SaveAs) {
    ...
    if (r == true) {
        ...
        $("#divLoading").show();
        $.ajax({
            url: '/notificationsettings/EmailSettingDelete',
            datatype: "json",
            data: det,
            type: "post",
            success: function (data) {
...
function sendTestEmail(EmailSettingsId) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/notificationsettings/sendTestEmail',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
