...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/onlinepaymentsettings/onlinepaymentsettingsfetch',
        datatype: "json",
        data: det,
        type: "post",
...
function insert(i) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/onlinepaymentsettings/OnlinePaymentSettingInsert',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
            ...
            if (data.Status == 0) {
                ...
                if (i == 1) {
                    window.location.href = "/onlinepaymentsettings/onlinepaymentsettings";
                }
                else {
                    window.location.href = "/onlinepaymentsettings/onlinepaymentsettingsadd";
                }
            }
...
function update(i) {
    ...
    var det = {
        OnlinePaymentSettingsId: window.location.href.split('=')[1],
        OnlinePaymentService: $('#ddlOnlinePaymentService').val(),
        PaypalClientId: $('#txtPaypalClientId').val(),
        PaypalCurrencyId: $('#ddlPaypalCurrency').val(),
        RazorpayKey: $('#txtRazorpayKey').val(),
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/onlinepaymentsettings/OnlinePaymentSettingUpdate',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function ActiveInactive(OnlinePaymentSettingsId, IsActive) {
    var det = {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/onlinepaymentsettings/OnlinePaymentSettingActiveInactive',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
...
function Delete(OnlinePaymentSettingsId, SaveAs) {
    ...
    if (r == true) {
        ...
        $("#divLoading").show();
        $.ajax({
            url: '/onlinepaymentsettings/OnlinePaymentSettingDelete',
            datatype: "json",
            data: det,
            type: "post",
            success: function (data) {
