...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/accountsreports/AccountTransactionsFetch',
        datatype: "json",
        data: det,
        type: "post",
...
function fetchAccountTransactions() {
    location.href = "/accountsreports/AccountTransactions?AccountId=" + $('#ddlAccount').val() + "&name=" + $("#ddlAccount option:selected").text() + "&Type=" + window.location.href.split('&')[2].split('=')[1] +'&Page=accounts';
}
