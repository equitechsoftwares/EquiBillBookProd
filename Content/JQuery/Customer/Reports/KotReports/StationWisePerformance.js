function fetchList(PageIndex) {
    var det = {
        ...
        KitchenStationId: parseInt($("#ddlKitchenStation").val()) || 0,
        FromDate: null,
        ToDate: null
    };
    ...
    $.ajax({
        url: '/kotreports/stationwiseperformancefetch',
        type: 'POST',
        data: det,
        success: function (data) {
            $("#tblStationWisePerformance").html(data);

            $('#tblStationWisePerformance').DataTable({
                lengthChange: false,
                searching: false,
                autoWidth: false,
                responsive: false,
