...
function fetchList(PageIndex) {
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/stationtype/index',
        datatype: "json",
        data: det,
        type: "post",
        success: function (data) {
            $("#tblStationTypes").html($(data).find("#tblStationTypes").html());
...
function insertStationType(i) {
    $('.errorText').hide();
    $('[style*="border: 2px"]').css('border', '');
    
    var det = {
        StationTypeId: 0,
        StationTypeName: $('#txtStationTypeName').val(),
...
function updateStationType(i) {
    $('.errorText').hide();
    $('[style*="border: 2px"]').css('border', '');
    
    var det = {
        StationTypeId: $('#StationTypeId').val() || 0,
        StationTypeName: $('#txtStationTypeName').val(),
        Description: $('#txtDescription').val(),
        IsActive: true,
        CompanyId: null,
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/stationtype/UpdateStationType',
        datatype: "json",
        data: JSON.stringify(det),
        contentType: "application/json",
        type: "post",
...
function deleteStationType(StationTypeId) {
    if (confirm('Are you sure you want to delete this station type?')) {
        var det = {
        ...
        $("#divLoading").show();
        $.ajax({
            url: '/stationtype/StationTypeDelete',
            datatype: "json",
            data: JSON.stringify(det),
            contentType: "application/json",
            type: "post",
...
function ActiveInactive(StationTypeId, IsActive) {
    var det = {
        StationTypeId: StationTypeId,
        IsActive: IsActive,
        CompanyId: null,
    ...
    $("#divLoading").show();
    $.ajax({
        url: '/stationtype/StationTypeActiveInactive',
        datatype: "json",
        data: JSON.stringify(det),
        contentType: "application/json",
        type: "post",
