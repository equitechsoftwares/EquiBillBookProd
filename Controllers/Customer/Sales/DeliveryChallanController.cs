...
namespace EquiBillBook.Controllers
{
    ...
    public class DeliveryChallanController : Controller
    {
        ...
        {
            ClsDeliveryChallanVm obj = new ClsDeliveryChallanVm();
            string[] arr = { "", "", "" };
            ...
            var deliveryChallanResult = await deliveryChallanController.AllDeliveryChallans(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(deliveryChallanResult);
            ...
            ViewBag.DeliveryChallans = oClsResponse.Data.DeliveryChallans;
            ...
            ViewBag.TotalItems = oClsResponse.Data.DeliveryChallans.Sum(x => x.TotalItems);
            ViewBag.TotalFreeQuantity = oClsResponse.Data.DeliveryChallans.Sum(x => x.FreeQuantity);
            ViewBag.TotalDiscount = oClsResponse.Data.DeliveryChallans.Sum(x => x.TotalDiscount);
            ViewBag.TotalAmount = oClsResponse.Data.DeliveryChallans.Sum(x => x.GrandTotal);
        ...
        public async Task<ActionResult> DeliveryChallanFetch(ClsDeliveryChallanVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            ViewBag.SaleSetting = oClsResponse12.Data.SaleSetting;
            //ViewBag.PosSetting = oClsResponse13.Data.PosSetting;
            return PartialView("PartialDeliveryChallan");
        }
        public async Task<ActionResult> Edit(long DeliveryChallanId)
        {
            ClsDeliveryChallanVm obj = new ClsDeliveryChallanVm();
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
                ...
                //ViewBag.CurrencySymbol = Request.Cookies["data"]["CurrencySymbol"];
                obj.UserType = "customer";
                obj.DeliveryChallanId = DeliveryChallanId;
            }
            obj.Type = "item";
            obj.CountryId = 2;
            serializer.MaxJsonLength = 2147483644;
            ...
            WebApi.DeliveryChallanController deliveryChallanController = new WebApi.DeliveryChallanController();
            var deliveryChallanResult = await deliveryChallanController.DeliveryChallan(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(deliveryChallanResult);
            ...
            var placeOfSupplyResult = await stateController.ActiveStates(stateObj);
            ClsResponse oClsResponse54 = await oCommonController.ExtractResponseFromActionResult(placeOfSupplyResult);
            ...
            ViewBag.DeliveryChallan = oClsResponse.Data.DeliveryChallan;
            ...
            ViewBag.Status = oClsResponse.Data.DeliveryChallan.Status;
        ...
        public async Task<ActionResult> Invoice(string InvoiceId)
        {
            ...
            WebApi.DeliveryChallanController deliveryChallanController = new WebApi.DeliveryChallanController();
            var result = await deliveryChallanController.Invoice(obj);
            ...
            ViewBag.TotalUnitPrice = oClsResponse.Data.DeliveryChallan.DeliveryChallanDetails.Select(a => a.UnitCost).DefaultIfEmpty().Sum();
            ViewBag.TotalQuantity = oClsResponse.Data.DeliveryChallan.DeliveryChallanDetails.Select(a => a.Quantity).DefaultIfEmpty().Sum();
        ...
        public async Task<ActionResult> DeliveryChallanCreate(long Id, string type)
        {
            ClsDeliveryChallanVm obj = new ClsDeliveryChallanVm();
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            ...
            if (type.ToLower() == "sales order")
            {
                ...
                ClsSalesOrderVm salesOrderObj = new ClsSalesOrderVm { AddedBy = obj.AddedBy, CompanyId = obj.CompanyId, SalesOrderId = obj.SalesOrderId };
                var salesOrderResult = await salesOrderController.SalesOrder(salesOrderObj);
                ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(salesOrderResult);

                obj.BranchId = oClsResponse.Data.SalesOrder.BranchId;
                ViewBag.DeliveryChallan = oClsResponse.Data.SalesOrder;
                ViewBag.TaxBreakups = oClsResponse.Data.Taxs;
            }
            else
            {
        ...
        public async Task<ActionResult> DeliveryChallanInsert(ClsDeliveryChallanVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.DeliveryChallanController deliveryChallanController = new WebApi.DeliveryChallanController();
            var result = await deliveryChallanController.InsertDeliveryChallan(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(result);
            return Json(oClsResponse);
        }
        public async Task<ActionResult> DeliveryChallanUpdate(ClsDeliveryChallanVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.DeliveryChallanController deliveryChallanController = new WebApi.DeliveryChallanController();
            var result = await deliveryChallanController.UpdateDeliveryChallan(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(result);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> DeliveryChallanDelete(ClsDeliveryChallanVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.DeliveryChallanController deliveryChallanController = new WebApi.DeliveryChallanController();
            var result = await deliveryChallanController.DeliveryChallanDelete(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(result);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> DeliveryChallanCancel(ClsDeliveryChallanVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.DeliveryChallanController deliveryChallanController = new WebApi.DeliveryChallanController();
            var result = await deliveryChallanController.DeliveryChallanCancel(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(result);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> DeliveryChallanDetailsDelete(ClsDeliveryChallanDetailsVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.DeliveryChallanController deliveryChallanController = new WebApi.DeliveryChallanController();
            var result = await deliveryChallanController.DeliveryChallanDetailsDelete(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(result);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> DeliveryChallanView(long DeliveryChallanId)
        {
            ClsDeliveryChallanVm obj = new ClsDeliveryChallanVm();
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            ...
            return PartialView("PartialDeliveryChallanView");
        }
        ...
        public async Task<ActionResult> UpdateDeliveryChallanStatus(ClsDeliveryChallanVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.DeliveryChallanController deliveryChallanController = new WebApi.DeliveryChallanController();
            var result = await deliveryChallanController.UpdateDeliveryChallanStatus(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(result);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> ActiveSellingPriceGroups(ClsDeliveryChallanVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
