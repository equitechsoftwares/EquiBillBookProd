...
namespace EquiBillBook.Controllers
{
    ...
    public class SalesOrderController : Controller
    {
        ...
        {
            ClsSalesOrderVm obj = new ClsSalesOrderVm();
            string[] arr = { "", "", "" };
            ...
            var salesOrderResult = await salesOrderController.AllSalesOrders(obj);
            ...
            ViewBag.SalesOrders = oClsResponse.Data.SalesOrders;
            ...
            ViewBag.TotalItems = oClsResponse.Data.SalesOrders.Sum(x => x.TotalItems);
            ViewBag.TotalFreeQuantity = oClsResponse.Data.SalesOrders.Sum(x => x.FreeQuantity);
            ViewBag.TotalDiscount = oClsResponse.Data.SalesOrders.Sum(x => x.TotalDiscount);
            ViewBag.TotalAmount = oClsResponse.Data.SalesOrders.Sum(x => x.GrandTotal);
        ...
        public async Task<ActionResult> SalesOrderFetch(ClsSalesOrderVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            ViewBag.SaleSetting = oClsResponse12.Data.SaleSetting;
            //ViewBag.PosSetting = oClsResponse13.Data.PosSetting;
            return PartialView("PartialSalesOrder");
        }
        public async Task<ActionResult> Edit(long SalesOrderId)
        {
            ClsSalesOrderVm obj = new ClsSalesOrderVm();
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            ...
            WebApi.SalesOrderController salesOrderController = new WebApi.SalesOrderController();
            var salesOrderResult = await salesOrderController.SalesOrder(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(salesOrderResult);
            ...
            ViewBag.SalesOrder = oClsResponse.Data.SalesOrder;
            ...
            ViewBag.Status = oClsResponse.Data.SalesOrder.Status;
        ...
        public async Task<ActionResult> Invoice(string InvoiceId)
        {
            ...
            WebApi.SalesOrderController salesOrderController = new WebApi.SalesOrderController();
            var invoiceResult = await salesOrderController.Invoice(obj);
            ...
            ViewBag.TotalUnitPrice = oClsResponse.Data.SalesOrder.SalesOrderDetails.Select(a => a.UnitCost).DefaultIfEmpty().Sum();
            ViewBag.TotalQuantity = oClsResponse.Data.SalesOrder.SalesOrderDetails.Select(a => a.Quantity).DefaultIfEmpty().Sum();
            ViewBag.TotalAmount = oClsResponse.Data.SalesOrder.SalesOrderDetails.Select(a => a.AmountIncTax).DefaultIfEmpty().Sum();
            ...
            try
            {
                ...
                {
                    CompanyId = oClsResponse.Data.SalesOrder.CompanyId,
                    AddedBy = oClsResponse.Data.SalesOrder.AddedBy
                };
                var saleSettingsResult = await saleSettingsController.SaleSetting(saleSettingsObj);
        ...
        public async Task<ActionResult> SalesOrderCreate(long Id, string type)
        {
            ClsSalesOrderVm obj = new ClsSalesOrderVm();
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            ...
            {
                ClsSalesQuotationVm quotationObj = new ClsSalesQuotationVm { AddedBy = obj.AddedBy, CompanyId = obj.CompanyId, SalesQuotationId = obj.SalesQuotationId, UserType = obj.UserType };
                ...
                oClsResponse = await oCommonController.ExtractResponseFromActionResult(quotationResult);

                obj.BranchId = oClsResponse.Data.SalesQuotation.BranchId;
                ViewBag.SalesOrder = oClsResponse.Data.SalesQuotation;
                ViewBag.TaxBreakups = oClsResponse.Data.Taxs;
            }
            else
            {
        ...
        public async Task<ActionResult> SalesOrderInsert(ClsSalesOrderVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesOrderController salesOrderController = new WebApi.SalesOrderController();
            var result = await salesOrderController.InsertSalesOrder(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(result);
            return Json(oClsResponse);
        }
        public async Task<ActionResult> SalesOrderUpdate(ClsSalesOrderVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesOrderController salesOrderController = new WebApi.SalesOrderController();
            var result = await salesOrderController.UpdateSalesOrder(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(result);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> SalesOrderdelete(ClsSalesOrderVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesOrderController salesOrderController = new WebApi.SalesOrderController();
            var result = await salesOrderController.SalesOrderDelete(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(result);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> SalesOrderDetailsDelete(ClsSalesOrderDetailsVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesOrderController salesOrderController = new WebApi.SalesOrderController();
            var result = await salesOrderController.SalesOrderDetailsDelete(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(result);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> SalesOrderView(long SalesOrderId)
        {
            ClsSalesOrderVm obj = new ClsSalesOrderVm();
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            ...
            return PartialView("PartialSalesOrderView");
        }
        ...
        public async Task<ActionResult> UpdateSalesOrderStatus(ClsSalesOrderVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesOrderController salesOrderController = new WebApi.SalesOrderController();
            var result = await salesOrderController.UpdateSalesOrderStatus(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(result);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> ActiveSellingPriceGroups(ClsSalesOrderVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
