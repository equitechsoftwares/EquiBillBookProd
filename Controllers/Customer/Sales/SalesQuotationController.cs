...
namespace EquiBillBook.Controllers
{
    ...
    public class SalesQuotationController : Controller
    {
        ...
        {
            ClsSalesQuotationVm obj = new ClsSalesQuotationVm();
            string[] arr = { "", "", "" };
            ...
            var salesQuotationResult = await salesQuotationController.AllSalesQuotations(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(salesQuotationResult);
            ...
            ViewBag.SalesQuotations = oClsResponse.Data.SalesQuotations;
            ...
            ViewBag.TotalItems = oClsResponse.Data.SalesQuotations.Sum(x => x.TotalItems);
            ViewBag.TotalFreeQuantity = oClsResponse.Data.SalesQuotations.Sum(x => x.FreeQuantity);
            ViewBag.TotalDiscount = oClsResponse.Data.SalesQuotations.Sum(x => x.TotalDiscount);
            ViewBag.TotalAmount = oClsResponse.Data.SalesQuotations.Sum(x => x.GrandTotal);
        ...
        public async Task<ActionResult> SalesQuotationFetch(ClsSalesQuotationVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            ViewBag.SaleSetting = oClsResponse12.Data.SaleSetting;
            //ViewBag.PosSetting = oClsResponse13.Data.PosSetting;
            return PartialView("PartialSalesQuotation");
        }
        public async Task<ActionResult> Edit(long SalesQuotationId)
        {
            ClsSalesQuotationVm obj = new ClsSalesQuotationVm();
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
                ...
                //ViewBag.CurrencySymbol = Request.Cookies["data"]["CurrencySymbol"];
                obj.UserType = "customer";
                obj.SalesQuotationId = SalesQuotationId;
            }
            obj.Type = "item";
            obj.CountryId = 2;
            serializer.MaxJsonLength = 2147483644;
            ...
            WebApi.SalesQuotationController salesQuotationController = new WebApi.SalesQuotationController();
            var salesQuotationResult = await salesQuotationController.SalesQuotation(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(salesQuotationResult);
            ...
            ViewBag.SalesQuotation = oClsResponse.Data.SalesQuotation;
            ...
            ViewBag.Status = oClsResponse.Data.SalesQuotation.Status;
        ...
        public async Task<ActionResult> Invoice(string InvoiceId)
        {
            ...
            WebApi.SalesQuotationController salesQuotationController = new WebApi.SalesQuotationController();
            var invoiceResult = await salesQuotationController.Invoice(obj);
            ...
            ViewBag.TotalUnitPrice = oClsResponse.Data.SalesQuotation.SalesQuotationDetails.Select(a => a.UnitCost).DefaultIfEmpty().Sum();
            ViewBag.TotalQuantity = oClsResponse.Data.SalesQuotation.SalesQuotationDetails.Select(a => a.Quantity).DefaultIfEmpty().Sum();
            ViewBag.TotalAmount = oClsResponse.Data.SalesQuotation.SalesQuotationDetails.Select(a => a.AmountIncTax).DefaultIfEmpty().Sum();
            ...
            try
            {
                ...
                {
                    CompanyId = oClsResponse.Data.SalesQuotation.CompanyId,
                    AddedBy = oClsResponse.Data.SalesQuotation.AddedBy
                };
                var saleSettingsResult = await saleSettingsController.SaleSetting(saleSettingsObj);
        ...
        public async Task<ActionResult> SalesQuotationInsert(ClsSalesQuotationVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesQuotationController salesQuotationController = new WebApi.SalesQuotationController();
            var insertResult = await salesQuotationController.InsertSalesQuotation(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(insertResult);
            return Json(oClsResponse);
        }
        public async Task<ActionResult> SalesQuotationUpdate(ClsSalesQuotationVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesQuotationController salesQuotationController = new WebApi.SalesQuotationController();
            var updateResult = await salesQuotationController.UpdateSalesQuotation(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(updateResult);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> SalesQuotationdelete(ClsSalesQuotationVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesQuotationController salesQuotationController = new WebApi.SalesQuotationController();
            var deleteResult = await salesQuotationController.SalesQuotationDelete(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(deleteResult);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> SalesQuotationDetailsDelete(ClsSalesQuotationDetailsVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesQuotationController salesQuotationController = new WebApi.SalesQuotationController();
            var deleteResult = await salesQuotationController.SalesQuotationDetailsDelete(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(deleteResult);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> SalesQuotationView(long SalesQuotationId)
        {
            ClsSalesQuotationVm obj = new ClsSalesQuotationVm();
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            ...
            return PartialView("PartialSalesQuotationView");
        }
        ...
        public async Task<ActionResult> UpdateSalesQuotationStatus(ClsSalesQuotationVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesQuotationController salesQuotationController = new WebApi.SalesQuotationController();
            var statusResult = await salesQuotationController.UpdateSalesQuotationStatus(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(statusResult);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> ActiveSellingPriceGroups(ClsSalesQuotationVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
