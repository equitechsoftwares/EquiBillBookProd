...
namespace EquiBillBook.Controllers
{
    ...
    public class SalesProformaController : Controller
    {
        // GET: SalesProforma
        ...
        public async Task<ActionResult> Index(long? BranchId, int? Date, int? Month, int? Year, long? CustomerId, string CustomerName)
        {
            ClsSalesProformaVm obj = new ClsSalesProformaVm();
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
                ...
                if (CustomerId != null)
                {
                    obj.CustomerId = Convert.ToInt64(CustomerId);
            ...
            var salesProformaResult = await salesProformaController.AllSalesProformas(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(salesProformaResult);
            ...
            //var res13 = await oCommonController.PostMethod(_json, oCommonController.baseUrl + "PosSettings/PosSetting", arr[0], arr[1], arr[2]);
            //ClsResponse oClsResponse13 = serializer.Deserialize<ClsResponse>(res13);
            ...
            ViewBag.SalesProformas = oClsResponse.Data.SalesProformas;
            ...
            ViewBag.MenuPermission = oClsResponse35.Data.MenuPermissions.Where(a => a.Menu.ToLower() == "delivery challan").FirstOrDefault();
            ...
            ViewBag.TotalItems = oClsResponse.Data.SalesProformas.Sum(x => x.TotalItems);
            ViewBag.TotalFreeQuantity = oClsResponse.Data.SalesProformas.Sum(x => x.FreeQuantity);
            ViewBag.TotalDiscount = oClsResponse.Data.SalesProformas.Sum(x => x.TotalDiscount);
            ViewBag.TotalAmount = oClsResponse.Data.SalesProformas.Sum(x => x.GrandTotal);
        ...
        public async Task<ActionResult> SalesProformaFetch(ClsSalesProformaVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            ViewBag.SaleSetting = oClsResponse12.Data.SaleSetting;
            //ViewBag.PosSetting = oClsResponse13.Data.PosSetting;
            return PartialView("PartialSalesProforma");
        }
        public async Task<ActionResult> Edit(long SalesProformaId)
        {
            ClsSalesProformaVm obj = new ClsSalesProformaVm();
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
                ...
                //ViewBag.CurrencySymbol = Request.Cookies["data"]["CurrencySymbol"];
                obj.UserType = "customer";
                obj.SalesProformaId = SalesProformaId;
            }
            obj.Type = "item";
            obj.CountryId = 2;
            serializer.MaxJsonLength = 2147483644;
            ...
            WebApi.SalesProformaController salesProformaController = new WebApi.SalesProformaController();
            var salesProformaResult = await salesProformaController.SalesProforma(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(salesProformaResult);
            ...
            //var res10 = await oCommonController.PostMethod(_json, oCommonController.baseUrl + "OnlinePaymentSettings/ActiveOnlinePaymentSettings", arr[0], arr[1], arr[2]);
            //ClsResponse oClsResponse10 = serializer.Deserialize<ClsResponse>(res10);
            ...
            //var res22 = await oCommonController.PostMethod(_json, oCommonController.baseUrl + "Account/ActiveAccounts", arr[0], arr[1], arr[2]);
            //ClsResponse oClsResponse22 = serializer.Deserialize<ClsResponse>(res22);
            ...
            ViewBag.SalesProforma = oClsResponse.Data.SalesProforma;
            ...
            ViewBag.Status = oClsResponse.Data.SalesProforma.Status;
        ...
        public async Task<ActionResult> Invoice(string InvoiceId)
        {
            ...
            WebApi.SalesProformaController salesProformaController = new WebApi.SalesProformaController();
            var invoiceResult = await salesProformaController.Invoice(obj);
            ...
            ViewBag.TotalUnitPrice = oClsResponse.Data.SalesProforma.SalesProformaDetails.Select(a => a.UnitCost).DefaultIfEmpty().Sum();
            ViewBag.TotalQuantity = oClsResponse.Data.SalesProforma.SalesProformaDetails.Select(a => a.Quantity).DefaultIfEmpty().Sum();
            ViewBag.TotalAmount = oClsResponse.Data.SalesProforma.SalesProformaDetails.Select(a => a.AmountIncTax).DefaultIfEmpty().Sum();
            ...
            try
            {
                ...
                {
                    CompanyId = oClsResponse.Data.SalesProforma.CompanyId,
                    AddedBy = oClsResponse.Data.SalesProforma.AddedBy
                };
                var saleSettingsResult = await saleSettingsController.SaleSetting(saleSettingsObj);
        ...
        public async Task<ActionResult> LoadModals()
        {
            ...
            WebApi.TaxController taxController2 = new WebApi.TaxController();
            ClsTaxVm taxObj2 = new ClsTaxVm { AddedBy = obj.AddedBy, CompanyId = obj.CompanyId };
            var taxResult = await taxController2.ActiveTaxs(taxObj2);
            ClsResponse oClsResponse38 = await oCommonController.ExtractResponseFromActionResult(taxResult);
        ...
        public async Task<ActionResult> SalesProformaCreate(long Id, string type)
        {
            ClsSalesProformaVm obj = new ClsSalesProformaVm();
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            ...
            if (type.ToLower() == "sales quotation")
            {
                ...
                var quotationResult = await salesQuotationController.SalesQuotation(quotationObj);
                ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(quotationResult);

                obj.BranchId = oClsResponse.Data.SalesQuotation.BranchId;
                ViewBag.SalesProforma = oClsResponse.Data.SalesQuotation;
                ViewBag.TaxBreakups = oClsResponse.Data.Taxs;
            }
            else if (type.ToLower() == "sales order")
            {
                ...
                var orderResult = await salesOrderController.SalesOrder(orderObj);
                ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(orderResult);

                obj.BranchId = oClsResponse.Data.SalesOrder.BranchId;
                ViewBag.SalesProforma = oClsResponse.Data.SalesOrder;
                ViewBag.TaxBreakups = oClsResponse.Data.Taxs;
            }
            else
            {
                WebApi.SalesProformaController salesProformaController = new WebApi.SalesProformaController();
                var proformaResult = await salesProformaController.SalesProforma(obj);
                ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(proformaResult);
            ...
            WebApi.TaxTypeController taxTypeController = new WebApi.TaxTypeController();
            ClsTaxTypeVm taxTypeObj = new ClsTaxTypeVm { CompanyId = obj.CompanyId, CountryId = 2 };
            var taxTypeResult = await taxTypeController.ActiveTaxTypes(taxTypeObj);
            ClsResponse oClsResponse51 = await oCommonController.ExtractResponseFromActionResult(taxTypeResult);
        ...
        public async Task<ActionResult> SalesProformaInsert(ClsSalesProformaVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesProformaController salesProformaController = new WebApi.SalesProformaController();
            var insertResult = await salesProformaController.InsertSalesProforma(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(insertResult);
            return Json(oClsResponse);
        }
        public async Task<ActionResult> SalesProformaUpdate(ClsSalesProformaVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesProformaController salesProformaController = new WebApi.SalesProformaController();
            var updateResult = await salesProformaController.UpdateSalesProforma(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(updateResult);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> SalesProformadelete(ClsSalesProformaVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesProformaController salesProformaController = new WebApi.SalesProformaController();
            var deleteResult = await salesProformaController.SalesProformaDelete(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(deleteResult);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> SalesProformaDetailsDelete(ClsSalesProformaDetailsVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesProformaController salesProformaController = new WebApi.SalesProformaController();
            var detailsDeleteResult = await salesProformaController.SalesProformaDetailsDelete(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(detailsDeleteResult);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> SalesProformaView(long SalesProformaId)
        {
            ClsSalesProformaVm obj = new ClsSalesProformaVm();
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            ...
            return PartialView("PartialSalesProformaView");
        }
        ...
        public async Task<ActionResult> SearchLot(ClsAvailableLots obj)
        {
            ...
            var searchLotResult = await itemController.SearchLot(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(searchLotResult);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> UpdateSalesProformaStatus(ClsSalesProformaVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
            ...
            WebApi.SalesProformaController salesProformaController = new WebApi.SalesProformaController();
            var statusUpdateResult = await salesProformaController.UpdateSalesProformaStatus(obj);
            ClsResponse oClsResponse = await oCommonController.ExtractResponseFromActionResult(statusUpdateResult);
            return Json(oClsResponse);
        }

        public async Task<ActionResult> ActiveSellingPriceGroups(ClsSalesProformaVm obj)
        {
            string[] arr = { "", "", "" };
            if (Request.Cookies["data"] != null)
            {
