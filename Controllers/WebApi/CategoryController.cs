...
namespace EquiBillBook.Controllers.WebApi
{
    ...
    public class CategoryController : ApiController
    {
        ...
        public async Task<IHttpActionResult> AllCategories(ClsCategoryVm obj)
        {
            if (obj.PageSize == 0)
            {
            ...
            var det = oConnectionContext.DbClsCategory.Where(a => a.CompanyId == obj.CompanyId && a.IsDeleted == false).Select(a => new
            {
                a.CategoryId,
                a.Category,
                //a.CategoryCode,
            ...
            {
                det = det.Where(a => a.Category.ToLower().Contains(obj.Search.ToLower())).ToList();
            }
            ...
            data = new
            {
                ...
                Data = new
                {
                    Categories = det.OrderByDescending(a => a.CategoryId).Skip(skip).Take(obj.PageSize).ToList(),
        ...
        public async Task<IHttpActionResult> Category(ClsCategory obj)
        {
            var det = oConnectionContext.DbClsCategory.Where(a => a.CategoryId == obj.CategoryId && a.CompanyId == obj.CompanyId).Select(a => new
            {
                a.CategoryId,
                a.Category,
                //a.CategoryCode,
        ...
        public async Task<IHttpActionResult> InsertCategory(ClsCategoryVm obj)
        {
            using (TransactionScope dbContextTransaction = new TransactionScope())
            {
                ...
                //if (obj.CategoryCode != "" && obj.CategoryCode != null)
                //{
                //    if (oConnectionContext.DbClsCategory.Where(a => a.CategoryCode.ToLower() == obj.CategoryCode.ToLower() && a.CompanyId == obj.CompanyId && a.IsDeleted == false && a.IsCancelled == false).Count() > 0)
                //    {
                //        errors.Add(new ClsError { Message = "Duplicate Category Code exists", Id = "divCategoryCode" });
                //        isError = true;
                //    }
                //}
                ...
                {
                    if (oConnectionContext.DbClsCategory.Where(a => a.Category.ToLower() == obj.Category.ToLower() && a.CompanyId == obj.CompanyId && a.IsDeleted == false).Count() > 0)
                    {
                        errors.Add(new ClsError { Message = "Duplicate Category Name exists", Id = "divCategory" });
                        isError = true;
                    }
                }
                ...
                //    obj.CategoryCode = prefixSettings.Prefix + prefixSettings.Counter.ToString().PadLeft(prefixSettings.NoOfDigits, '0');
                //}
                ...
                ClsActivityLogVm oClsActivityLogVm = new ClsActivityLogVm()
                {
                    ...
                    Category = "Categories",
                    CompanyId = obj.CompanyId,
                    Description = "Category \"" + obj.Category + "\" created",
                    Id = oCategory.CategoryId,
        ...
        public async Task<IHttpActionResult> UpdateCategory(ClsCategoryVm obj)
        {
            using (TransactionScope dbContextTransaction = new TransactionScope())
            {
                bool isError = false;
                ...
                if (obj.Category != "" && obj.Category != null)
                {
                    if (oConnectionContext.DbClsCategory.Where(a => a.Category.ToLower() == obj.Category.ToLower() && a.CategoryId != obj.CategoryId && a.CompanyId == obj.CompanyId && a.IsDeleted == false).Count() > 0)
                    {
                        errors.Add(new ClsError { Message = "Duplicate Category Name exists", Id = "divCategory" });
                        isError = true;
                    }
                ...
                //if (obj.CategoryCode != "" && obj.CategoryCode != null)
                //{
                //    if (oConnectionContext.DbClsCategory.Where(a => a.CategoryCode == obj.CategoryCode && a.CategoryId != obj.CategoryId && a.CompanyId == obj.CompanyId).Count() > 0)
                //    {
                //        data = new
                //        {
                //            Status = 0,
                //            Message = "Duplicate Category Code exists",
                //            Data = new
                //            {
                //            }
                //        }; return await Task.FromResult(Ok(data));
                ...
                oConnectionContext.DbClsCategory.Attach(oCategory);
                oConnectionContext.Entry(oCategory).Property(x => x.CategoryId).IsModified = true;
                oConnectionContext.Entry(oCategory).Property(x => x.Category).IsModified = true;
                //oConnectionContext.Entry(oCategory).Property(x => x.CategoryCode).IsModified = true;
                oConnectionContext.Entry(oCategory).Property(x => x.ModifiedBy).IsModified = true;
                oConnectionContext.Entry(oCategory).Property(x => x.ModifiedOn).IsModified = true;
                oConnectionContext.SaveChanges();
                ...
                ClsActivityLogVm oClsActivityLogVm = new ClsActivityLogVm()
                {
                    ...
                    Category = "Categories",
                    CompanyId = obj.CompanyId,
                    Description = "Category \"" + obj.Category + "\" updated",
                    Id = oCategory.CategoryId,
                    IpAddress = obj.IpAddress,
                    Platform = obj.Platform,
                    Type = "Update"
        ...
        public async Task<IHttpActionResult> CategoryActiveInactive(ClsCategoryVm obj)
        {
            using (TransactionScope dbContextTransaction = new TransactionScope())
            {
                var CurrentDate = oCommonController.CurrentDate(obj.CompanyId);
                ClsCategory oClsRole = new ClsCategory()
                {
                    CategoryId = obj.CategoryId,
                    IsActive = obj.IsActive,
                    ModifiedBy = obj.AddedBy,
                ...
                oConnectionContext.DbClsCategory.Attach(oClsRole);
                oConnectionContext.Entry(oClsRole).Property(x => x.CategoryId).IsModified = true;
                ...
                ClsActivityLogVm oClsActivityLogVm = new ClsActivityLogVm()
                {
                    ...
                    Category = "Categories",
                    CompanyId = obj.CompanyId,
                    Description = "Category \"" + oConnectionContext.DbClsCategory.Where(a => a.CategoryId == obj.CategoryId).Select(a => a.Category).FirstOrDefault() + (obj.IsActive == true ? "\" activated " : "\" deactivated "),
                    Id = oClsRole.CategoryId,
                    IpAddress = obj.IpAddress,
                    Platform = obj.Platform,
                    Type = "Update"
                };
                ...
                {
                    Status = 1,
                    Message = "Category " + (obj.IsActive == true ? "activated" : "deactivated") + " successfully",
                    Data = new
                    {
                    }
                };
        ...
        public async Task<IHttpActionResult> CategoryDelete(ClsCategoryVm obj)
        {
            using (TransactionScope dbContextTransaction = new TransactionScope())
            {
                int SubCategoryCount = oConnectionContext.DbClsSubCategory.Where(a => a.CompanyId == obj.CompanyId && a.CategoryId == obj.CategoryId && a.IsDeleted == false).Count();
                int ItemCount = oConnectionContext.DbClsItem.Where(a => a.CompanyId == obj.CompanyId && a.CategoryId == obj.CategoryId && a.IsDeleted == false).Count();
                ...
                ClsActivityLogVm oClsActivityLogVm = new ClsActivityLogVm()
                {
                    ...
                    Category = "Categories",
                    CompanyId = obj.CompanyId,
                    Description = "Category \"" + oConnectionContext.DbClsCategory.Where(a => a.CategoryId == obj.CategoryId).Select(a => a.Category).FirstOrDefault() + "\" deleted",
                    Id = oClsRole.CategoryId,
                    IpAddress = obj.IpAddress,
                    Platform = obj.Platform,
                    Type = "Delete"
        ...
        public async Task<IHttpActionResult> ActiveCategorys(ClsCategoryVm obj)
        {
            var det = oConnectionContext.DbClsCategory.Where(a => a.CompanyId == obj.CompanyId && a.IsDeleted == false && a.IsActive == true).Select(a => new
            {
                CategoryId = a.CategoryId,
                Category = a.Category,
                SubCategoryCount = oConnectionContext.DbClsSubCategory.Where(b => b.CategoryId == a.CategoryId && b.IsDeleted == false && b.IsActive == true).Count(),
        ...
        public async Task<IHttpActionResult> AllActveCategory_SubCategory_SubSubCAtegory(ClsCategoryVm obj)
        {
            var det = oConnectionContext.DbClsCategory.Where(a => a.CompanyId == obj.CompanyId && a.IsDeleted == false && a.IsActive == true).Select(a => new
            {
                //ParentCategory = "",
                ...
                CategoryId = a.CategoryId,
                Category = a.Category,
            }).Union(oConnectionContext.DbClsSubCategory.Where(a => a.CompanyId == obj.CompanyId && a.IsDeleted == false && a.IsActive == true).Select(a => new
            {
                //ParentCategory = oConnectionContext.DbClsCategory.Where(b => b.CategoryId == a.CategoryId).Select(b => b.Category).FirstOrDefault(),
                Type = "sub category",
                CategoryId = a.CategoryId,
                Category = a.SubCategory,
            })).Union(oConnectionContext.DbClsSubSubCategory.Where(a => a.CompanyId == obj.CompanyId && a.IsDeleted == false && a.IsActive == true).Select(a => new
            {
                //ParentCategory = oConnectionContext.DbClsCategory.Where(b => b.CategoryId == a.CategoryId).Select(b => b.Category).FirstOrDefault() + " -> " +oConnectionContext.DbClsSubCategory.Where(b => b.SubCategoryId == a.SubCategoryId).Select(b => b.SubCategory).FirstOrDefault(),
                Type = "sub sub category",
                CategoryId = a.CategoryId,
                Category = a.SubSubCategory,
            })).ToList();
            data = new
            {
                Status = 1,
        ...
        public async Task<IHttpActionResult> CategoryPurchaseSalesReport(ClsPurchaseSales obj)
        {
            ...
            List<ClsPurchaseSales> det = oConnectionContext.DbClsCategory.Where(a => a.IsActive == true && a.IsDeleted == false && a.CompanyId == obj.CompanyId).Select(a => new ClsPurchaseSales
            {
                Name = a.Category,
                TotalPurchase = (from b in oConnectionContext.DbClsPurchase
                                 ...
                                 where b.BranchId == obj.BranchId && d.CategoryId == a.CategoryId && b.IsDeleted == false && b.IsCancelled == false && d.IsDeleted == false && c.IsDeleted == false
                ...
                TotalPurchasePaid = (from b in oConnectionContext.DbClsPurchase
                                     ...
                                     where b.BranchId == obj.BranchId && d.CategoryId == a.CategoryId && e.Type.ToLower() == "purchase payment" &&
                ...
                TotalSalesPaid = (from b in oConnectionContext.DbClsSales
                                  ...
                                  where b.BranchId == obj.BranchId && d.CategoryId == a.CategoryId && (e.Type.ToLower() == "sales payment") &&
                                  b.IsDeleted == false && b.IsCancelled == false && c.IsDeleted == false && d.IsDeleted == false && e.IsDeleted == false && e.IsCancelled == false
                                  select e.Amount).DefaultIfEmpty().Sum(),
        ...
        public async Task<IHttpActionResult> CategoryProfitLossReport(ClsUserVm obj)
        {
            List<ClsPurchaseSales> PurchaseSales = oConnectionContext.DbClsCategory.Where(a => a.IsActive == true && a.IsDeleted == false && a.CompanyId == obj.CompanyId).Select(a => new ClsPurchaseSales
            {
                Name = a.Category,
                //TotalPurchase = (from b in oConnectionContext.DbClsPurchase
                //                 join c in oConnectionContext.DbClsPurchaseDetails on b.PurchaseId equals c.PurchaseId
                //                 join d in oConnectionContext.DbClsItem on c.ItemId equals d.ItemId
                //                 where b.BranchId == obj.BranchId && d.CategoryId == a.CategoryId && b.IsDeleted == false && b.IsCancelled == false && d.IsDeleted == false && d.IsCancelled == false && c.IsDeleted == false && c.IsCancelled == false
        ...
        public async Task<IHttpActionResult> SalesByCategoryReport(ClsSalesDetailsVm obj)
        {
            //var userDetails = oConnectionContext.DbClsUser.Where(a => a.UserId == obj.AddedBy).AsEnumerable().Select(a => new
            //{
            //    a.IsCompany,
            ...
            List<ClsPurchaseSales> det = oConnectionContext.DbClsCategory.Where(a => a.IsActive == true && a.IsDeleted == false
            && a.CompanyId == obj.CompanyId).Select(a => new ClsPurchaseSales
            {
                ...
                SalesDetails = (from b in oConnectionContext.DbClsSales
                                join c in oConnectionContext.DbClsSalesDetails on b.SalesId equals c.SalesId
                                join d in oConnectionContext.DbClsItem on c.ItemId equals d.ItemId
                                where d.CategoryId == a.CategoryId && b.Status != "Draft"
                ...
                SalesReturnDetails = (from b in oConnectionContext.DbClsSalesReturn
                                      ...
                                      where e.CategoryId == a.CategoryId && b.Status != "Draft"
            ...
            if (obj.CategoryId != 0)
            {
                det = det.Select(a => new ClsPurchaseSales
                {
                    ...
                    SalesReturnDetails = a.SalesReturnDetails.Where(b => b.CategoryId == obj.CategoryId).Select(b => new ClsSalesReturnDetailsVm
                    {
                        ItemId = b.ItemId,
                        CustomerId = b.CustomerId,
                        SubCategoryId = b.SubCategoryId,
            ...
            data = new
            {
                ...
                Data = new
                {
                    SalesDetails = SalesDetails.Where(a => a.AmountIncTax > 0).OrderByDescending(a => a.CategoryId).Skip(skip).Take(obj.PageSize).ToList(),
        ...
        public async Task<IHttpActionResult> SalesDetailsByCategory(ClsSalesDetailsVm obj)
        {
            if (obj.FromDate == DateTime.MinValue)
            {
                int d = oConnectionContext.DbClsBusinessSettings.Where(a => a.CompanyId == obj.CompanyId).Select(a => a.FinancialYearStartMonth).FirstOrDefault();
...
l.UserId == obj.AddedBy && l.IsActive == true && l.IsDeleted == false).Any(l => l.BranchId == b.BranchId)
        ...
        public async Task<IHttpActionResult> SalesReturnDetailsByCategory(ClsSalesDetailsVm obj)
        {
            if (obj.FromDate == DateTime.MinValue)
            {
                int d = oConnectionContext.DbClsBusinessSettings.Where(a => a.CompanyId == obj.CompanyId).Select(a => a.FinancialYearStartMonth).FirstOrDefault();
       ...
       && DbFunctions.TruncateTime(b.Date) >= obj.FromDate &&
           DbFunctions.TruncateTime(b.Date) <= obj.ToDate
           && a.AmountIncTax != 0 && c.CategoryId == obj.CategoryId && b.Status != "Draft"
                                select new ClsBankPaymentVm
                                {
                                    Id = b.SalesReturnId,
                                    AddedOn = b.Date,
       ...
       && DbFunctions.TruncateTime(b.Date) >= obj.FromDate &&
        ...
        public async Task<IHttpActionResult> PurchaseByCategoryReport(ClsSalesDetailsVm obj)
        {
            //var userDetails = oConnectionContext.DbClsUser.Where(a => a.UserId == obj.AddedBy).AsEnumerable().Select(a => new
            //{
            //    a.IsCompany,
            ...
            && a.CompanyId == obj.CompanyId).Select(a => new ClsPurchaseSales
            {
                ...
                l.UserId == obj.AddedBy && l.IsActive == true && l.IsDeleted == false).Any(l => l.BranchId == b.BranchId)
                     ...
                     DbFunctions.TruncateTime(b.PurchaseDate) <= obj.ToDate
                                   ...
                                   {
                                       PurchaseDetailsId = c.PurchaseDetailsId,
                                       CategoryId = d.CategoryId,
                                       BranchId = b.BranchId,
                                       ItemId = c.ItemId,
            ...
            if (obj.CategoryId != 0)
            {
                det = det.Select(a => new ClsPurchaseSales
                {
                    ...
                    PurchaseReturnDetails = a.PurchaseReturnDetails.Where(b => b.CategoryId == obj.CategoryId).Select(b => new ClsPurchaseReturnDetailsVm
                    {
                        ItemId = b.ItemId,
                        SupplierId = b.SupplierId,
                        SubCategoryId = b.SubCategoryId,
            ...
            data = new
            {
                ...
                Data = new
                {
                    PurchaseDetails = PurchaseDetails.Where(a => a.AmountIncTax > 0).OrderByDescending(a => a.CategoryId).Skip(skip).Take(obj.PageSize).ToList(),
        ...
        public async Task<IHttpActionResult> PurchaseDetailsByCategory(ClsSalesDetailsVm obj)
        {
            if (obj.FromDate == DateTime.MinValue)
            {
                int d = oConnectionContext.DbClsBusinessSettings.Where(a => a.CompanyId == obj.CompanyId).Select(a => a.FinancialYearStartMonth).FirstOrDefault();
...
l.UserId == obj.AddedBy && l.IsActive == true && l.IsDeleted == false).Any(l => l.BranchId == b.BranchId)
        ...
        public async Task<IHttpActionResult> PurchaseReturnDetailsByCategory(ClsSalesDetailsVm obj)
        {
            if (obj.FromDate == DateTime.MinValue)
            {
                int d = oConnectionContext.DbClsBusinessSettings.Where(a => a.CompanyId == obj.CompanyId).Select(a => a.FinancialYearStartMonth).FirstOrDefault();
        ...
        [AllowAnonymous]
        public async Task<IHttpActionResult> PublicCategorys(ClsCategoryVm obj)
        {
            var det = oConnectionContext.DbClsCategory.Where(a => a.CompanyId == obj.CompanyId && a.IsDeleted == false && a.IsActive == true).Select(a => new
            {
                CategoryId = a.CategoryId,
                Category = a.Category,
                SubCategories = oConnectionContext.DbClsSubCategory.Where(b => b.CategoryId == a.CategoryId && b.IsDeleted == false && b.IsActive == true)
                .Select(b => new
                {
                    b.SubCategory,
                    b.SubCategoryId,
                    SubSubCategories = oConnectionContext.DbClsSubSubCategory.Where(c => c.SubCategoryId == b.SubCategoryId
